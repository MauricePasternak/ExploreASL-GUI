...
import { ImportSchemaType, SourcedataFolderType } from "../../types/ImportSchemaTypes";
...
export const ImportModule__SourcedataStructureTest: YupTestFunction<ImportSchemaType, "SourcedataStructure"> = async (
	folderStruct,
	helpers
) => {
...
export const ImportModule__MappingScanAliasesTest: YupTestFunction<ImportSchemaType, "MappingScanAliases"> = (
	mapping,
	helpers
) => {
...
export const MappingSessionAliasesTest: YupTestFunction<ImportSchemaType, "MappingSessionAliases"> = (mapping) => {
...
export const ImportModule__M0PositionInASLTest = (m0Pos: number[], helpers: Yup.TestContext<ImportSchemaType>) => {
...
export const ImportModule__SingleContextPathsTest: YupTestFunction<
	ImportSchemaType,
	`ImportContexts.${number}.Paths`
> = async (paths, helpers) => {
...
export const ImportModule__BolusCutOffDelayTimeTest: YupTestFunction<
	ImportSchemaType,
	`ImportContexts.${number}.BolusCutOffDelayTime`
> = (value, helpers) => {
...
export const ImportModule__BackgroundSuppressionPulseTimeTest: YupTestFunction<
	ImportSchemaType,
	`ImportContexts.${number}.BackgroundSuppressionPulseTime`
> = (pulseTimes, helpers) => {
