...
export const Schema_Manufacturer = SchemaMin_Manufacturer.required(
	"Manufacturer is a required field for ASL processing"
);
...
export const Schema_MagneticFieldStrength = SchemaMin_MagneticFieldStrength.required(
	"Magnetic Field Strength is a required field for ASL processing"
);
