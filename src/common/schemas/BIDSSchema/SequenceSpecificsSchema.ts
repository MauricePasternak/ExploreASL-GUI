...
export const SchemaMin_PulseSequenceType = Yup.string()
	...
	.oneOf(
		["2D_EPI", "3D_spiral", "3D_GRASE"],
		`Pulse Sequence Type must be one of the following: "2D EPI", "3D Spiral", "3D GRASE"`
	);
...
export const Schema_MRAcquisitionType = SchemaMin_MRAcquisitionType.required(
	"MR Acquisition Dimensionality is a required field"
);
