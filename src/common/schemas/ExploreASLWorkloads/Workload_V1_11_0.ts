...
export const Mapping_1_11_0: EASLWorkload = {
	"010_DCM2NII.status": {
		module: "Import",
	...
	"001_create_templates_1.status": {
		module: "DARTEL",
		description: "First iteration (out of 6) of creating DARTEL templates",
		loadingBarValue: 100,
	},
	"001_create_templates_2.status": {
		module: "DARTEL",
		description: "Second iteration (out of 6) of creating DARTEL templates",
		loadingBarValue: 100,
	},
	"001_create_templates_3.status": {
		module: "DARTEL",
		description: "Third iteration (out of 6) of creating DARTEL templates",
		loadingBarValue: 100,
	},
	"001_create_templates_4.status": {
		module: "DARTEL",
		description: "Fourth iteration (out of 6) of creating DARTEL templates",
		loadingBarValue: 100,
	},
	"001_create_templates_5.status": {
		module: "DARTEL",
		description: "Fifth iteration (out of 6) of creating DARTEL templates",
		loadingBarValue: 100,
	},
	"001_create_templates_6.status": {
		module: "DARTEL",
		description: "Sixth iteration (out of 6) of creating DARTEL templates",
		loadingBarValue: 100,
	},
	...
	"001_LongitudinalRegistration.status": {
		module: "LongReg",
		description: "Longitudinal registration of T1w images",
		loadingBarValue: 100,
	},
	"002_Resample.status": {
		module: "LongReg",
		description: "Reslicing of T1w images at latter timepoints to the first timepoint",
		loadingBarValue: 100,
	},
