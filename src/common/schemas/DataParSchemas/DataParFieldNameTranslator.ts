...
export const DataParFieldNameTranslator: Partial<Record<FieldPath<DataParValuesType>, string>> = {
	...
	"x.modules.asl.ApplyQuantification": "Apply Quantification Settings",
	"x.modules.asl.ApplyQuantification.0": "Apply Quantification Settings - first value",
	"x.modules.asl.ApplyQuantification.1": "Apply Quantification Settings - second value",
	"x.modules.asl.ApplyQuantification.2": "Apply Quantification Settings - third value",
	"x.modules.asl.ApplyQuantification.3": "Apply Quantification Settings - fourth value",
	"x.modules.asl.ApplyQuantification.4": "Apply Quantification Settings - fifth value",
	"x.modules.asl.ApplyQuantification.5": "Apply Quantification Settings - sixth value",
