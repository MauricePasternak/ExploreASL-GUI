		...
		<>
			...
			<DialogContent>
				<Stack spacing={1}>
					...
					<section>
						<Accordion
							expanded={expanded === "panel__postlabelingdelayinfo"}
							onChange={handleAccordionChange("panel__postlabelingdelayinfo")}
						>
							<AccordionSummary expandIcon={<ExpandMoreIcon />}>
								<Typography>
									I have a PASL sequence. Can you clarify what Post Labeling Delay corresponds to as well as the Bolus
									Labeling Delay Time?
								</Typography>
							</AccordionSummary>
							<Divider />
							<AccordionDetails>
								<p>
									Indeed, there may be some confusion between BIDS and the Alsop consensus paper&apos;s definitions of
									the term. The latter makes the following quote:
								</p>
								<br />
								<blockquote>
									&quot;The PLD in PCASL is analogous to the quantity (TI-TI<sub>1</sub>)&quot;
								</blockquote>
								<br />
								<p>
									As such one may be tempted to input the value of&nbsp;(TI-TI<sub>1</sub>) as the Post Labeling Delay
									for a PASL sequence. <strong>DO NOT</strong> do this. In BIDS, which this application follows, the
									Post Labeling Delay is just TI for PASL sequences.
								</p>
								<br />
								<p>
									For more information, please see the following figure or visit{" "}
									<SecureLink href="https://bids-specification.readthedocs.io/en/stable/appendices/arterial-spin-labeling.html#pasl-sequence">
										the BIDS documentation highlighting this
									</SecureLink>
									:
									<br />
                  <br />
									<Box
										...
										maxWidth={600}
										component="img"
										src={HelperImage__ImportPostLabelingDelay}
									/>
								</p>
							</AccordionDetails>
						</Accordion>
