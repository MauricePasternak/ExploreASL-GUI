...
const ExploreASLTypeOptions: RHFSelectOption<ImportSchemaType, "EASLType">[] = [
  { label: "ExploreASL from GitHub", value: "Github" },
  { label: "Compiled ExploreASL", value: "Compiled" },
];

export function StepDefineRuntimeEnvs({
  currentStep,
  setCurrentStep,
  control,
  handleSubmit,
              ...
              <Grid container rowSpacing={3} columnSpacing={3} marginTop={0} padding={1}>
                ...
                <Grid item xs={12} md={6} xl={4}>
                  <RHFFilepathInput
                    ...
                    filepathType="dir"
                    dialogOptions={{ properties: ["openDirectory"], title: "Select MATLAB Runtime v## Directory" }}
