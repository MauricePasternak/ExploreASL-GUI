...
import { SubmitErrorHandler, SubmitHandler, UseFormReset } from "react-hook-form";
				...
				<Box mt={3} pb={5}>
					<Card>
						...
						<CardContent>
							...
							<ButtonGroup variant="contained" fullWidth color="inherit" sx={{ mt: 2 }}>
								<Button
					...
					>
						...
						<Button
							size="large"
							disabled={isSubmitting || procStatus !== "Standby"}
...
function ConfirmResetDialog({
	...
	setResetDialogOpen: React.Dispatch<React.SetStateAction<boolean>>;
	setCurrentStep: React.Dispatch<React.SetStateAction<number>>;
	reset: UseFormReset<ImportSchemaType>;
}) {
	return (
		<Dialog open={resetDialogOpen}>
			<DialogTitle>Reset Back to First Step?</DialogTitle>
			<DialogContent>
				<DialogContentText>Are you sure you want to reset the module and go back to the first step?</DialogContentText>
			</DialogContent>
			<DialogActions>
