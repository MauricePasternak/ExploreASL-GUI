...
function AboutPage() {
  return (
    <Box display="flex" flexDirection="column" alignItems="center" gap={2} className="AboutPage__MainContainer">
        ...
        <Accordion>
          ...
          <AccordionDetails>
            ...
            <p>
              ...
              the structure of the dataset - which folder levels house subject names versus visit designations versus
              scan type, etc. This will permit the program to convert all DICOM files into NIFTI format (necessary for
              image processing) and organize this NIFTI output into BIDS standard output folders:{" "}
        ...
        <Accordion>
          ...
          <AccordionDetails>
            ...
            <p>
              ...
              advocacy of the &quot;A Beginner&rsquo;s Guide to Arterial Spin Labeling (ASL) Image Processing&quot;
              paper which will feature this program as a core tool.
            </p>
          </AccordionDetails>
        </Accordion>
      </Paper>
