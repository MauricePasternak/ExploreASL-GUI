					...
					<Grid container rowSpacing={0} columnSpacing={3} marginTop={0} padding={2}>
						<Grid item xs={12} md={6} xl={4}>
							<RHFCheckable
								...
								helperText="Whether to use SPM12's segmentation algorithms instead of CAT12's."
								isSwitch={true}
								valWhenChecked={1}
								valWhenUnchecked={0}
							/>
						...
						<Grid item xs={12} md={6} xl={4}>
							<RHFCheckable
								...
								helperText="Whether CAT12 should provide volumetric ROI results for the Hammers Atlas."
								isSwitch={true}
								valWhenChecked={1}
								valWhenUnchecked={0}
							/>
						...
						<Grid item xs={12} md={6} xl={4}>
							<RHFCheckable
								...
								helperText="Whether structural scans should be resampled to a resolution compatible with CAT12."
								isSwitch={true}
								valWhenChecked={true}
						...
						<Grid item xs={12} md={6} xl={4}>
							<RHFCheckable
								...
								helperText="Run within-subject structural scan registration"
								isSwitch={true}
								valWhenChecked={1}
								valWhenUnchecked={0}
							/>
						...
						<Grid item xs={12} md={6} xl={4}>
							<RHFCheckable
								...
								control={control}
								label="Run DARTEL"
								helperText="Creates a population template and performs between-subject registration of MNI-template normalized structural images to the population template."
								isSwitch={true}
								valWhenChecked={1}
								valWhenUnchecked={0}
							/>
