...
const M0Options: RHFSelectOption<DataParValuesType, "x.Q.M0">[] = [
...
const VendorOptions: RHFSelectOption<DataParValuesType, "x.Q.Vendor">[] = [
	{ label: "Siemens", value: "Siemens" },
	{ label: "General Electric", value: "GE_product" },
	{ label: "Philips", value: "Philips" },
];

const SequenceOptions: RHFSelectOption<DataParValuesType, "x.Q.Sequence">[] = [
	{ label: "3D GRaSE", value: "3D_GRASE" },
	{ label: "3D Spiral", value: "3D_spiral" },
	{ label: "2D EPI", value: "2D_EPI" },
];

const readoutDimOptions: RHFSelectOption<DataParValuesType, "x.Q.readoutDim">[] = [
	{ label: "2D", value: "2D" },
	{ label: "3D", value: "3D" },
];

const LabellingOptions: RHFSelectOption<DataParValuesType, "x.Q.LabelingType">[] = [
...
export const TabSequenceParameters = React.memo(
						...
						<Grid container rowSpacing={3} columnSpacing={3} marginTop={0} padding={2}>
							...
							<Grid item xs={12} md={6} xl={4}>
								<RHFTextField
									...
									helperText="Specify as comma-separated positive integers representing timings in milliseconds. Leave blank if not applicable."
