...
> = ControlledFilepathTextFieldBaseProps & ControllerFieldPropType<TValues, TName> & RestrictedTextFieldProps;
...
type RHFFilepathTextFieldProps<
  TValues extends FieldValues,
  TName extends Path<TValues> = Path<TValues>
> = ControlledFilepathTextFieldPropsNoField<TValues, TName> & UseControllerPropsBaseType<TValues, TName>;
