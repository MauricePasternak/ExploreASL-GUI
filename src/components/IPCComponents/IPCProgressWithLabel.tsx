...
function IPCProgressWithLabelProps({ channelName, incrementType = "Increment", ...props }: IPCProgressWithLabelProps) {
...
export default React.memo(IPCProgressWithLabelProps);
