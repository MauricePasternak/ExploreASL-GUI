...
type RHFMultiNumericBaseProps<TFV extends FieldValues, TName extends FieldPath<TFV>> = {
...
> = RHFMultiNumericBaseProps<TFV, TName> &
...
>({
	...
	const handleChange = (value: string | number, index: number, currArr: number[]) => {
		...
		onChange && onChange(newValues as FieldPathValue<TFV, TName>);
	};
