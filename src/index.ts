import { app, BrowserWindow, BrowserWindowConstructorOptions, globalShortcut, ipcMain, protocol, shell } from "electron";
...
import MappingIPCMainEventsToHanders from "./communcations/MappingIPCMainEventsToHanders";
