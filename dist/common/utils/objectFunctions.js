 ...
 *
 */
export function stringRecordToFlatArray(record, keyPredicate, valuePredicate, keysFirst = true) {
 ...
 * ```
 */
export function assignSelfKeysOnly(object, valuesDonor, deep = true) {
