...
export class RegexMatch {
    constructor(matchArray) {
        this.groupsObject = matchArray === null || matchArray === void 0 ? void 0 : matchArray.groups;
...
export class Regex {
    ...
    search(target) {
        ...
        return match != null ? new RegexMatch(match) : false;
    }
    /**
     ...
     */
    replace(sourceString, substitutionString) {
